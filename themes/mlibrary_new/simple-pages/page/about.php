...
<section>
  <div class="col-xs-12 about-online-exhibits">
    <h1>Online Exhibits at the University of Michigan</h1>
    ...
    <h2 id='image-rights'>Using images from this website</h2>
    <p>The University of Michigan Library has placed copies of these works online for educational and research purposes. These works may be under copyright. If you decide to use any of these works, you are responsible for making your own legal assessment and securing any necessary permission.</p>
    <p class='about-contact'> If you have questions about the Online Exhibit web site or the inclusion of an item in an exhibit, please contact <a href='mailto:ask-omeka@umich.edu'>ask-omeka@umich.edu</a></p>
</div>
</div>
</section> 
