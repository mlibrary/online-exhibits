...
{	
  ...
  if($file->hasThumbnail()){
      ...
      $html_fullsize_image= 'Click the image to launch gallery view'.display_file($file, array('imageSize'=>'fullsize','linkAttributes'=>array('rel'=>'fancy_group', 'class'=>'fancyitem','title' => item('Dublin Core', 'Title'))),array('class' => 'fullsize', 'id' => 'item-image')); 
      $fullsizeimage=true;
      $html_thumnailsize_image= display_file($file, array('imageSize'=>'square_thumbnail','linkToFile'=>false),array('class' => 'square_thumbnail'));      
    }
		elseif ($fullsizeimage==true){
      $html_fullsize_image .=display_file($file, array('imageSize'=>'fullsize','linkAttributes'=>array('rel'=>'fancy_group', 'class'=>'fancyitem','title' => item('Dublin Core', 'Title'))),array('class' => 'fullsize', 'style'=>'display:none', 'id' => 'item-image')); 
...
<!--  The following function prints all the the metadata associated with an item: Dublin Core, extra element sets, etc. See http://omeka.org/codex or the examples on items/browse for information on how to print only select metadata fields. -->
    ...
    //alert("hello");   
   jQuery(this).siblings(".fullsize").hide();
