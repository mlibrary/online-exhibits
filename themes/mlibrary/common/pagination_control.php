...
<ul class="pagination">
    ...
    <li class="pagination_previous">
        ...
        <a href="<?php echo html_escape($this->url(array(), null, $getParams)); ?>"><?php echo 'Previous';//echo __('&lt;'); ?></a>
    </li>
    <?php endif; ?>
    ...
    <li class="pagination_next">
        ...
        <a href="<?php echo html_escape($this->url(array(), null, $getParams)); ?>"><?php echo 'Next';//echo __('&gt;'); ?></a>
    </li>
    <?php endif; ?>
</ul>
