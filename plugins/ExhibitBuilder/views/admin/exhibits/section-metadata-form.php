...
<form method="post" accept-charset="utf-8" action="" id="section-metadata-form" class="exhibit-builder">
    ...
    <?php if ((get_theme_option('View Items in Gallery')!='pages_2') || ((exhibit_builder_section_has_pages($exhibitSection)) < 1)){ ?>
    
	<fieldset>
		<p id="exhibit-builder-save-changes"><input type="submit" name="section_form" value="<?php echo __('Save Changes'); ?>" /> <?php echo __('or'); ?> 		
		    <input type="submit" name="page_form" id="page_form" value="<?php echo __('Add Page'); ?>" />
		     <?php echo __('or'); ?> <a href="<?php echo html_escape(uri(array('module'=>'exhibit-builder', 'controller'=>'exhibits', 'action'=>'edit', 'id'=>$exhibitSection->exhibit_id))); ?>"><?php echo __('Cancel'); ?></a></p>
	</fieldset>
	<?php }
	else { ?>
	<fieldset>
		<p id="exhibit-builder-save-changes"><input type="submit" name="section_form" value="<?php echo __('Save Changes'); ?>" /> <?php echo __('or'); ?> 		
		<a href="<?php echo html_escape(uri(array('module'=>'exhibit-builder', 'controller'=>'exhibits', 'action'=>'edit', 'id'=>$exhibitSection->exhibit_id))); ?>"><?php echo __('Cancel'); ?></a></p>
	</fieldset>
	<?php }?>
</form>
</div>
