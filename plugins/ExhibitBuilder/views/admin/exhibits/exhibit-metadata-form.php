           ...
           <div class="five columns omega inputs">
             <fieldset id="lib-tags">
              ...
              if (!empty($subjectvalue['name'])) {
                    echo "<li class='subject-parent'>". $this->formCheckbox($subjectvalue['name']).
                         "<label for='".$subjectvalue['name']."'><a href='#' class='subjectshow_hide'>".
                         $subjectvalue['name']."</a></label>";
              ?>
              <div class='internalslidingDiv'>
                <ul>
                  <?php foreach ($subjectvalue->topic as $value) {
                        if ($value->xpath("sub-topic")) {
                           print "<li class='subject-parent '>".$this->formCheckbox($value['name']).
                                 "<label for='".$value['name']."'><a href='#' class='subject-nested'>".
                                 $value['name']."</a></label>"; ?>
                                    <div class='subject-sub-internalslidingDiv'>
                                      <ul>
                                          <?php foreach ($value->xpath("sub-topic") as $subvalue) {
                                             print "<li class='sub-list'>".
                                                   $this->formCheckbox($subvalue['name']).
                                                   "<label for='".$subvalue['name']."'>".
                                                   $subvalue['name']."</label>";
                                           }?>
                                        </ul>
                                      </div>
